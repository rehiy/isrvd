      ...
      <div class="bg-slate-50 border-b border-slate-200 rounded-t-2xl px-4 md:px-6 py-3">
        ...
        <div class="flex md:hidden items-center justify-between gap-2">
          ...
          <div class="flex items-center gap-1 flex-shrink-0">
            ...
            <button @click="$router.back()" class="w-9 h-9 rounded-lg bg-amber-500 hover:bg-amber-600 flex items-center justify-center text-white transition-colors" title="返回">
