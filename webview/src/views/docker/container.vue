...
<template>
  <div>
    ...
    <div class="card mb-4">
        ...
        <div class="hidden md:flex md:items-center justify-between">
          ...
          <div v-if="container" class="flex gap-1 bg-slate-100 p-1 rounded-lg">
            <button
              ...
              :class="[
                'px-3 py-2 text-xs font-medium rounded-md transition-all duration-200 flex items-center gap-1.5',
      ...
      <div class="p-6">
        <router-view :container="container" :container-id="containerId" />
      </div>
    </div>
  </div>
</template>
