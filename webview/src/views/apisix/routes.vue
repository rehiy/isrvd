      ...
      <div class="card-toolbar">
        ...
        <div class="hidden md:flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            <button v-if="portal.hasPerm('POST /api/apisix/route')" class="btn btn-sm btn-indigo" @click="openCreateModal()"><i class="fas fa-plus"></i>新建路由</button>
          </div>
        </div>
        <!-- 移动端 -->
        <div class="flex md:hidden items-center justify-between">
          ...
          <div class="flex items-center gap-1 flex-shrink-0">
            ...
            <button v-if="portal.hasPerm('POST /api/apisix/route')" class="btn btn-sm btn-indigo w-9 h-9 !px-0" title="新建路由" @click="openCreateModal()">
